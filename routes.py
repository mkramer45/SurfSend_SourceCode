...
app.config['MAIL_USERNAME'] = 'myemailadress@gmail.com'
...
def send_reset_email(user):
	...
	msg = Message('Password Reset Request',
				  sender='myemailadress@gmail.com',
...
def forgot():
	...
	if form.validate_on_submit():
		...
		if user:
			...
			email_list = 'myemailadress@gmail.com'
			...
			msg = MIMEMultipart()
			msg['From'] = 'myemailadress@gmail.com'
			...
			mailserver.ehlo()
			mailserver.login('myemailadress@gmail.com', 'mypassword')

			mailserver.sendmail('myemailadress@gmail.com',email_list,msg.as_string())
